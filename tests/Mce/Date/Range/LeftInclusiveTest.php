...
require_once dirname( __FILE__ ) . '/../../../../lib/Mce/Date/Range/LeftInclusive.php';

use \DateTime,
    \DateInterval,
    \Mce\Date\Range\LeftInclusive as Range;

/**
 * @author Matthew Conger-Eldeen <mceldeen@gmail.com>
 */
class LeftInclusiveTest extends \PHPUnit_Framework_TestCase
{
    /**
